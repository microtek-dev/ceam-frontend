import { SlButton, SlDialog, SlInput, SlOption, SlSelect, SlTag } from '@shoelace-style/shoelace/dist/react/index';
	...
	return (
		<div className="vendor-master-main">
			...
			<div className="table-ceam">
				<MUIDataTable title="Vendor Data" data={vendorList} columns={column} options={options}></MUIDataTable>
			</div>
			<SlDialog label="Add Employee" open={openAddEmp} onSlRequestClose={() => setOpenAddEmp(false)}>
				<div className="add-vendor-inputs-main">
					...
					<SlSelect
						label="Plant Name"
						onSlChange={(e) => {
							setSendVendor({ ...sendVendor, plant_name: e.target.value.split('_').join(' ') });
						}}>
