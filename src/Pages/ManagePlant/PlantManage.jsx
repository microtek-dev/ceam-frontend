...
function PlantManage() {
            ...
            <div className="edit-button-main">
              <SlTag
                ...
                onClick={(e) => {
                  ...
                  setUpdateData({
                    ...updateData,
                    id: plantData[dataIndex].id,
                    plant: plantData[dataIndex].plant,
                    division: plantData[dataIndex].division,
                  });
  ...
  function sendCreatePlant() {
    ...
    axios({
      method: "post",
      url: `${import.meta.env.VITE_API_URL}/mhere/create-roster-location`,
      headers: {
  ...
  function sendRosterLocationUpdate() {
    ...
    axios({
      method: "post",
      url: `${import.meta.env.VITE_API_URL}/mhere/update-roster-location`,
      headers: {
        "Content-Type": "application/json",
      },
      data: updateData,
  ...
  function sendRosterLocationDelete() {
    ...
    axios({
      method: "post",
      url: `${import.meta.env.VITE_API_URL}/mhere/delete-roster-location`,
      headers: {
        "Content-Type": "application/json",
      },
      data: delData,
  ...
  function getPlantData() {
    axios({
      method: "get",
      url: `${import.meta.env.VITE_API_URL}/mhere/get-roster-location`,
      headers: {
        "Content-Type": "application/json",
      },
    })
  ...
  return (
    <div className="plant-manage-main">
      ...
      <SlDialog
        label="Update"
        open={openUpdatePlant}
        onSlRequestClose={() => setOpenUpdatePlant(false)}
      >
        ...
        <SlButton
          ...
          outline
          variant="danger"
          onClick={() => setOpenUpdatePlant(false)}
        >
          Close
        </SlButton>
      </SlDialog>
      ...
      <SlDialog
        label="Add Plant"
        open={addPlantDialog}
        onSlRequestClose={() => setAddPlantDialog(false)}
      >
        <div className="update-plant-dialog-inputs">
          <SlInput
            label="Plant Name"
        ...
        <SlButton
          slot="footer"
          variant="primary"
          onClick={() => setAddPlantDialog(false)}
        >
          Close
        </SlButton>
      </SlDialog>
      <SlDialog
        label="Add Division"
        open={openAddDivisionDialog}
        onSlRequestClose={() => setOpenAddDivisionDialog(false)}
      >
        <div>
          <SlSelect
        ...
        <SlButton
          slot="footer"
          variant="primary"
          onClick={() => setOpenAddDivisionDialog(false)}
        >
          Close
        </SlButton>
      </SlDialog>
