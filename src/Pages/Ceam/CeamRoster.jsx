 ...
 */}
      ...
      <SlDialog
        label="Upload Roster"
        open={openUpload}
        onSlRequestClose={() => setOpenUpload(false)}
      >
        <SlInput
          onSlChange={(e) => {
            setUploadDateData(e.target.value);
        ...
        <FormControl style={{ marginBottom: "15px", width: "100%" }}>
          ...
          <Select
            ...
            onChange={(e) => {
              ...
              setPlantName(selectedValue.split("_").join(" "));
        ...
        <FormControl style={{ marginBottom: "15px", width: "100%" }}>
          ...
          <Select
            ...
            onChange={(e) => {
              const selectedValue = e.target.value;
              setDivision(selectedValue.split("_").join(" "));
            }}
          >
            {divisionList?.map((item, i) => (
              <MenuItem
      ...
      <SlDialog
        label="Dialog"
        open={openPending}
        onSlRequestClose={() => setOpenPending(false)}
      >
        <SlInput
          onSlChange={(e) => {
            ...
            setPendingRosterData({
              ...
              max: `${lastDayOfMonth.getFullYear()}-${
                lastDayOfMonth.getMonth() + 1 < 10
