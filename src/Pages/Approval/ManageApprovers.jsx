...
function ManageApprovers() {
            ...
            <div className="edit-button-main">
              <SlTag
                ...
                onClick={(e) => {
                  ...
                  setUpdateData({
                    ...updateData,
                    matrix_id: rosterApprovers[dataIndex].matrix_id,
                    plant: rosterApprovers[dataIndex].plant,
                    division: rosterApprovers[dataIndex].division,
                    approver_employee_id:
                      rosterApprovers[dataIndex].employee_id,
                    level_1_approver: rosterApprovers[dataIndex]
                      .level_1_approver
                      ? true
                      : false,
                    level_2_approver: rosterApprovers[dataIndex]
                      .level_2_approver
                      ? true
                      : false,
                    approval_type: rosterApprovers[dataIndex].approval_type,
                  });
                  setOpenUpdateApprover(true);
                }}
  ...
  function addNewApprover() {
    ...
    axios({
      method: "post",
      url: `${import.meta.env.VITE_API_URL}/mhere/create-roster-approval`,
      headers: {
        "Content-Type": "application/json",
      },
  ...
  function deleteApprover() {
    ...
    axios({
      method: "post",
      url: `${import.meta.env.VITE_API_URL}/mhere/delete-roster-approval`,
      headers: {
        "Content-Type": "application/json",
      },
      data: delData,
  ...
  function sendRosterApproverUpdate() {
    ...
    axios({
      method: "post",
      url: `${import.meta.env.VITE_API_URL}/mhere/update-roster-approval`,
      headers: {
        "Content-Type": "application/json",
      },
      data: updateData,
  ...
  return (
    <div className="manage-approvers-main">
      ...
      <SlDialog
        label="Confirm"
        open={openDelete}
        onSlRequestClose={() => setOpenDelete(false)}
      >
      ...
      <SlDialog
        label="Update"
        open={openUpdateApprover}
        onSlRequestClose={() => setOpenUpdateApprover(false)}
      >
        <div className="">
          <SlSelect
            style={{ marginBottom: "15px" }}
            value={updateData.plant}
            label="Select Plant"
            onSlChange={(e) => {
          ...
          <SlSelect
            style={{ marginBottom: "15px" }}
            value={updateData.level_1_approver}
            label="Select Level 1"
            onSlChange={(e) => {
              setUpdateData({
                ...updateData,
                level_1_approver: e.target.value,
              });
            }}
          >
          ...
          <SlSelect
            ...
            value={updateData.level_2_approver}
            onSlChange={(e) => {
              setUpdateData({
                ...updateData,
                level_2_approver: e.target.value,
              });
            }}
          >
            <SlMenuItem value={true}>True</SlMenuItem>
        ...
        <SlButton
          ...
          outline
          variant="danger"
          onClick={() => setOpenUpdateApprover(false)}
        >
          Close
        </SlButton>
      </SlDialog>
      <SlDialog
        label="Add New"
        open={openAddNew}
        onSlRequestClose={() => setOpenAddNew(false)}
      >
        <div>
          <SlInput
            style={{ marginBottom: "15px" }}
            label="Employee ID"
            value={newApproverData.approver_employee_id}
            onSlBlur={(e) => {
              setNewApproverData({
                ...newApproverData,
                approver_employee_id: e.target.value,
              });
            }}
          />
          <SlSelect
            style={{ marginBottom: "15px" }}
            value={newApproverData.plant}
            label="Select Plant"
            onSlChange={(e) => {
          ...
          <SlSelect
            style={{ marginBottom: "15px" }}
            value={newApproverData.division}
            label="Division"
            onSlChange={(e) => {
              setNewApproverData({
                ...newApproverData,
          ...
          <SlSelect
            style={{ marginBottom: "15px" }}
            value={newApproverData.approval_type}
          ...
          <SlSelect
            style={{ marginBottom: "15px" }}
            value={newApproverData.level_1_approver}
            label="Select Level 1"
            onSlChange={(e) => {
              setNewApproverData({
                ...newApproverData,
          ...
          <SlSelect
            label="Select Level 2"
            value={newApproverData.level_2_approver}
            onSlChange={(e) => {
              setNewApproverData({
                ...newApproverData,
                level_2_approver: e.target.value,
